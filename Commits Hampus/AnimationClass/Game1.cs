...
namespace AnimationClass
{
  ...
  public class Game1 : Game
  {
    ...
    Texture2D Enemy;
    public Rectangle Enemyrect = new Rectangle(500,350,40,60);
    ...
    protected override void LoadContent()
    {
      ...
      // NOTE: I no-longer use this reference as it affects different objects if being used multiple times!
        ...
        Enemy =(Content.Load<Texture2D>("Enemy/darthmaulAFK"));
    ...
    protected override void Draw(GameTime gameTime)
    {
      ...
      foreach (var sprite in _sprites)
        ...
        spriteBatch.Draw(Enemy,new Rectangle(500,350,40,60),Color.White);
