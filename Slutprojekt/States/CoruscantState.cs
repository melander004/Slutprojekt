  ...
  public class CoruscantState : State
  {
      ...
      : base(game, graphicsDevice, content)
    {
      ...
      var animations = new Dictionary<string, Animation>(){
        { "PlayerF", new Animation(_game.Content.Load<Texture2D>("Enemy/AnakinF"), 13) },
        { "PlayerB", new Animation(_game.Content.Load<Texture2D>("Enemy/AnakinB"), 13) },
        { "PlayerA", new Animation(_game.Content.Load<Texture2D>("Enemy/AnakinAtt"), 3) },
        { "PlayerAFK", new Animation(_game.Content.Load<Texture2D>("Enemy/Anakin"), 1) },
      };
